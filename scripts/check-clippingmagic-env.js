...
console.log('CLIPPINGMAGIC_API_KEY:', apiKey ? `Found (${apiKey})` : 'NOT FOUND');
console.log('CLIPPING_MAGIC_API_SECRET:', apiSecret ? `Found (length: ${apiSecret.length})` : 'NOT FOUND');
