...
async function runMigration() {
  try {
    ...
    const migrationPath = path.join(
      ...
      'supabase',
      'migrations',
      '011_create_notifications_system.sql'
    );
    ...
    if (error) {
      ...
      console.log(
        'ℹ️  Direct SQL execution not available, creating tables individually...'
      );
      ...
      for (const statement of statements) {
        try {
          ...
          console.log(
            '⚠️  Note: You may need to run the migration through Supabase SQL editor'
          );
          break;
        } catch (err) {
    ...
    if (testError) {
      ...
      console.log(
        '3. Copy the contents of: supabase/migrations/011_create_notifications_system.sql'
      );
    ...
    console.log(
      '1. Copy the migration from: supabase/migrations/011_create_notifications_system.sql'
    );
