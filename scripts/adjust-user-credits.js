...
if (!email || isNaN(adjustment)) {
  console.log('Usage: node scripts/adjust-user-credits.js <email> <adjustment> [reason]');
  console.log('Example: node scripts/adjust-user-credits.js user@example.com -10 "Correcting duplicate credit allocation"');
  console.log('Example: node scripts/adjust-user-credits.js user@example.com 5 "Compensation for issue"');
  process.exit(1);
}
