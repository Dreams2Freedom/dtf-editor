...
import { Upload, Loader2, Edit3, Download, Scissors, Sparkles } from 'lucide-react';
...
export function ImageEditor() {
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      toast.success(`Edited ${data.images.length} image${data.images.length > 1 ? 's' : ''}! ${totalCost} credits used.`);
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mb-2">
                  Upload a mask to specify which areas to edit. White areas will be edited, black areas preserved.
                </p>
                <div 
          ...
          <Card className="p-6">
            ...
            <div className="mb-4">
              <label className="flex items-center gap-2">
                ...
                />
                <span className="text-sm font-medium">Optimize for DTF Printing</span>
              </label>
          ...
          <Card className="p-6 min-h-[400px]">
            ...
            {isEditing && (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-gray-600">Editing your image{options.count > 1 ? 's' : ''}...</p>
