          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="grid grid-cols-2 gap-2 sm:hidden">
              ...
              <button
                ...
                className="col-span-2 flex items-center justify-center gap-2 px-3 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50 active:bg-gray-100 transition-colors"
                type="button"
              >
