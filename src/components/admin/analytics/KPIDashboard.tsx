  ...
  const fetchKPIData = async () => {
    try {
      ...
      const response = await fetch(
        `/api/admin/analytics/kpi?range=${timeRange}`
      );
            ...
            <div className="space-y-3">
              <div>
                <p className="text-3xl font-bold">
                  {formatPercentage(kpiData.conversion.rate)}
                </p>
                <p
                  className={`text-sm flex items-center gap-1 mt-1 ${getTrendColor(kpiData.conversion.trend)}`}
                >
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatPercentage(kpiData.conversion.freeToBasic)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Free → Starter</span>
                  <span className="font-medium">
                    {formatPercentage(kpiData.conversion.freeToStarter)}
                  </span>
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              <div>
                <p className="text-3xl font-bold">
                  {formatPercentage(kpiData.churn.rate)}
                </p>
                <p
                  className={`text-sm flex items-center gap-1 mt-1 ${getTrendColor(kpiData.churn.trend, true)}`}
                >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatPercentage(kpiData.churn.byPlan.basic)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Starter Plan</span>
                  <span className="font-medium">
                    {formatPercentage(kpiData.churn.byPlan.starter)}
                  </span>
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              <div>
                <p className="text-3xl font-bold">
                  {formatCurrency(kpiData.financial.arpu)}
                </p>
                <p
                  className={`text-sm flex items-center gap-1 mt-1 ${getTrendColor(kpiData.financial.arpuTrend)}`}
                >
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatCurrency(kpiData.financial.ltv)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">CAC</span>
                  <span className="font-medium">
                    {formatCurrency(kpiData.financial.cac)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">LTV:CAC</span>
                  <span className="font-medium">
                    {kpiData.financial.ltvCacRatio
                      ? kpiData.financial.ltvCacRatio.toFixed(1)
                      : '0.0'}
                    :1
                  </span>
                </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              <div>
                <p className="text-3xl font-bold">
                  {formatPercentage(kpiData.growth.userGrowthRate)}
                </p>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatNumber(kpiData.growth.newUsersThisMonth)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">MAU Growth</span>
                  <span className="font-medium">
                    {formatPercentage(kpiData.growth.mauGrowth)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Referral Rate</span>
                  <span className="font-medium">
                    {formatPercentage(kpiData.growth.referralRate)}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="text-center">
                  <p className="text-2xl font-bold">
                    {formatPercentage(kpiData.retention.day1)}
                  </p>
                  <p className="text-sm text-gray-600 mt-1">Day 1</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold">
                    {formatPercentage(kpiData.retention.day7)}
                  </p>
                  <p className="text-sm text-gray-600 mt-1">Day 7</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold">
                    {formatPercentage(kpiData.retention.day30)}
                  </p>
                  <p className="text-sm text-gray-600 mt-1">Day 30</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold">
                    {formatPercentage(kpiData.retention.day90)}
                  </p>
              ...
              <div className="bg-blue-50 rounded-lg p-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-blue-700">
                    Retention rates show the percentage of users who return
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 rounded-lg bg-gray-50">
              ...
              <p className="text-2xl font-bold">
                {kpiData.financial.paybackPeriod
                  ? kpiData.financial.paybackPeriod.toFixed(1)
                  : '0.0'}
              </p>
            ...
            <div className="text-center p-4 rounded-lg bg-gray-50">
              ...
              <p
                className={`text-2xl font-bold ${
                  kpiData.financial.ltvCacRatio >= 3
                    ? 'text-green-600'
                    : kpiData.financial.ltvCacRatio >= 1
                      ? 'text-yellow-600'
                      : 'text-red-600'
                }`}
              >
            ...
            <div className="text-center p-4 rounded-lg bg-gray-50">
              ...
              <p
                className={`text-2xl font-bold ${
                  kpiData.churn.monthlyChurn <= 5
                    ? 'text-green-600'
                    : kpiData.churn.monthlyChurn <= 10
                      ? 'text-yellow-600'
                      : 'text-red-600'
                }`}
              >
