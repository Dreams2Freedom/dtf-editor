...
import { Mail, Send, AlertCircle, User, Users, Tag } from 'lucide-react';
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700">
                    Emails will be sent to actual users. Make sure to review
          ...
          {selectedUsers.length === 1 && (
            <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              <p className="text-sm font-medium text-gray-700 mb-2">
                Preview (personalized for first recipient):
              </p>
              <div className="bg-white rounded p-3 text-sm">
                <p className="font-medium mb-2">
                  Subject: {personalizeMessage(subject, selectedUsers[0])}
                </p>
