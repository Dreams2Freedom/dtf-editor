...
export class AuthService {
  ...
  // Update user profile
  private async updateUserProfile(userId: string, updates: {
    firstName?: string
    lastName?: string
    company?: string
    phone?: string
  ...
  // Log user activity
  async logActivity(userId: string, activityType: string, activityData?: Record<string, unknown>): Promise<void> {
    try {
      const { error } = await this.supabase
