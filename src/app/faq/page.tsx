...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'We support JPEG, PNG, and WebP files for upload. All processed images are delivered as high-quality PNG files at 300 DPI with transparent backgrounds (when background removal is used), perfect for DTF printing.',
    category: 'Getting Started'
  },
  {
    id: 'mobile-support',
    question: 'Can I use DTF Editor on my phone?',
    answer: 'Yes! DTF Editor is designed mobile-first, meaning it works perfectly on smartphones and tablets. You can create and edit designs on the go, then download them directly to your device.',
    category: 'Getting Started'
  },
    ...
    answer: (
      <div>
        ...
        <ul className="list-disc list-inside mt-2 space-y-1">
          <li><strong>1 credit</strong> = 1 image processing operation</li>
  ...
  },
  {
    ...
    answer: 'Yes! All new users receive 2 free credits upon signup to try our tools. Free users also get 2 credits that refresh monthly.',
    category: 'Credits & Pricing'
  },
  {
    id: 'pricing-plans',
  ...
  // Features
  {
    ...
    answer: 'Our background removal tool uses advanced AI to automatically detect and remove backgrounds from your images. Simply upload your image, and our system will process it to create a transparent background PNG. The result is automatically cropped to fit with minimal padding (0.05%) for optimal printing.',
    category: 'Features'
  },
  {
    id: 'image-upscaling',
  ...
  },
  {
    ...
    answer: 'Vectorization converts raster images (made of pixels) into vector format (made of mathematical paths). This is ideal for logos, simple graphics, or when you need to resize an image without losing quality. Vector images can be scaled to any size without becoming pixelated.',
    category: 'Features'
  },
  {
    id: 'ai-generation',
  ...
  },
  {
    ...
    answer: 'Yes! Our AI editing feature (available to paid subscribers) allows you to select parts of an image and modify them using text prompts. You can change colors, add or remove elements, or transform specific areas while keeping the rest of the image intact.',
    category: 'Features'
  },
  ...
  // Storage & Gallery
  {
    ...
    answer: (
      <div>
        ...
        <ul className="list-disc list-inside mt-2 space-y-1">
          <li><strong>Free users:</strong> 48 hours</li>
  ...
  },
  {
    ...
    answer: 'Yes! In your image gallery, you can select multiple images using the checkbox mode and then download them all as a ZIP file or delete them in bulk. This is great for managing large collections of designs.',
    category: 'Storage & Gallery'
  },
  {
    id: 'search-gallery',
    question: 'How do I find specific images in my gallery?',
    answer: 'Your gallery includes powerful search and filter options. You can search by filename, filter by processing type (upscale, background removal, etc.), select date ranges, and sort by various criteria like newest, oldest, file size, or name.',
    category: 'Storage & Gallery'
  },
  ...
  // Technical
  {
    ...
    answer: 'The maximum file size for uploads is 10MB. If you have larger files, we recommend compressing them first or using an image editing tool to reduce the file size before uploading.',
    category: 'Technical'
  },
  {
    id: 'output-quality',
    question: 'What quality are the output files?',
    answer: 'All processed images are exported at 300 DPI (dots per inch) in PNG format, which is the industry standard for high-quality DTF printing. This ensures your prints will be sharp and professional-looking.',
    category: 'Technical'
  },
  {
    id: 'browser-support',
    question: 'Which browsers are supported?',
    answer: 'DTF Editor works best on modern browsers including Chrome, Safari, Firefox, and Edge. We recommend keeping your browser updated to the latest version for the best experience.',
    category: 'Technical'
  },
  {
    id: 'offline-use',
    question: 'Can I use DTF Editor offline?',
    answer: 'No, DTF Editor requires an internet connection as it uses cloud-based AI services to process your images. This ensures you always get the latest and best processing capabilities without needing powerful hardware.',
    category: 'Technical'
  },
  ...
  },
  {
    ...
    answer: 'Processing time depends on the image size and complexity. Most operations complete within 10-30 seconds. AI image generation may take up to 60 seconds. If processing takes longer than 2 minutes, try refreshing the page and attempting again.',
    category: 'Troubleshooting'
  },
  {
