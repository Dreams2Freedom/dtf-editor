        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Please read these terms carefully before using DTF Editor
              services.
            </p>
          ...
          <div className="space-y-8">
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-4">
                  By accessing or using DTF Editor ("Service"), you agree to be
                ...
                <p className="text-gray-600">
                  ...
                  customers using our AI-powered image processing tools for
                  Direct to Film (DTF) printing applications.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-4">
                  DTF Editor provides AI-powered image processing services
                  including:
                </p>
                <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                  ...
                  <li>
                    Process images containing personal data without consent
                  </li>
                ...
                <div className="space-y-4 text-gray-600">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>
                        Processing operations consume credits based on the
                        operation type
                      </li>
                      <li>Free tier includes 2 credits per month</li>
                      <li>
                        Paid subscriptions include monthly credit allocations
                      </li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>
                        Subscription fees are billed in advance monthly or
                        annually
                      </li>
                      <li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>
                        <strong>7-Day Money Back Guarantee:</strong> New
                        subscribers may request a full refund within 7 days of
                        their first subscription
                      </li>
                      <li>
                        <strong>Failed Processing:</strong> Credits are
                        automatically refunded if image processing fails due to
                        technical issues
                      </li>
                      <li>
                        <strong>Annual Plans:</strong> May be cancelled within
                        30 days for a pro-rated refund
                      </li>
                      <li>
                        <strong>Used Credits:</strong> No refunds for
                        successfully used credits
                      </li>
                      <li>
                        <strong>Unused Credits:</strong> Subscription credits
                        expire monthly and do not carry over unless specified in
                        your plan
                      </li>
                    </ul>
                  </div>
                ...
                <div className="space-y-4 text-gray-600">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      ...
                      <li>
                        You grant us a license to process, store, and display
                        your images
                      </li>
                      <li>
                        You grant us permission to use uploaded and processed
                        images for promotional purposes, including but not
                        limited to:
                      </li>
                      ...
                      <li>
                        You can request removal of your images from promotional
                        materials by contacting support
                      </li>
                      <li>
                        You are responsible for having rights to all uploaded
                        content
                      </li>
                      <li>
                        You warrant that uploaded content does not infringe on
                        third-party rights
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      ...
                      <li>
                        You may not copy or reverse engineer any part of the
                        Service
                      </li>
                    </ul>
                  </div>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  ...
                  Policy. By using the Service, you consent to the collection
                  and use of information as detailed in our Privacy Policy. We
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      We are not liable for any indirect or consequential
                      damages
                    </li>
                    <li>
                      Our total liability is limited to the amount paid in the
                      last 12 months
                    </li>
                    <li>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                  ...
                  <li>
                    Processed images may be deleted 30 days after termination
                  </li>
                  <li>
                    Termination does not affect any outstanding payment
                    obligations
                  </li>
                </ul>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  ...
                  Your continued use of the Service after the changes
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  ...
                  arising from these Terms will be resolved through binding
