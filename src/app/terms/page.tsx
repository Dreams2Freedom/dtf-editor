  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="prose prose-gray max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 py-12">
        ...
        <p>
          By accessing or using DTF Editor (&ldquo;Service&rdquo;), you agree to be
          bound by these Terms of Service (&ldquo;Terms&rdquo;). If you disagree
        ...
        <ul>
          ...
          <li>You grant us permission to use uploaded and processed images for promotional purposes, including but not limited to:
            <ul>
