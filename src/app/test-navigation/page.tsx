        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-white rounded-lg shadow">
            <h2 className="font-semibold mb-2">
              Test 2: Background Removal (No Params)
            </h2>
            <Button
              onClick={() => {
                console.log(
                  'Test 2: Navigate to background removal without params'
                );
          ...
          <div className="p-4 bg-white rounded-lg shadow">
            <h2 className="font-semibold mb-2">
              Test 3: Background Removal with Simple URL
            </h2>
            <Button
              onClick={() => {
                const url =
                  '/process/background-removal?imageUrl=https://example.com/test.jpg';
          ...
          <div className="p-4 bg-white rounded-lg shadow">
            <h2 className="font-semibold mb-2">
              Test 4: Background Removal with Encoded URL
            </h2>
            <Button
              onClick={() => {
          ...
          <div className="p-4 bg-white rounded-lg shadow">
            ...
            <Button
              onClick={() => {
                ...
                console.log(
                  'Test 6: Navigate with data URL, length:',
                  url.length
                );
                router.push(url);
              }}
