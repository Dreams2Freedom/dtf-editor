        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-1">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Track your inquiries easily</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
            ...
            <div className="bg-purple-50 rounded-xl p-6">
              <h4 className="font-semibold text-gray-900 mb-2">Before You Contact Us</h4>
              <p className="text-sm text-gray-600 mb-3">
                You might find quick answers in our:
              </p>
              <ul className="space-y-2">
                <li>
                  <a href="/faq" className="text-purple-600 hover:text-purple-700 text-sm font-medium">
                    → Frequently Asked Questions
                  </a>
                </li>
                <li>
                  <a href="/support" className="text-purple-600 hover:text-purple-700 text-sm font-medium">
                    → Support Center
                  </a>
                </li>
              </ul>
