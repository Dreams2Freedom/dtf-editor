        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Monitor and manage your image storage, track usage patterns, and optimize your space.
            </p>
          </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              Delete processed images you no longer need to free up space.
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 rounded-full bg-blue-500 mt-2"></div>
                          <div>
                            <p className="font-medium">Download Important Files</p>
                            <p className="text-sm text-gray-600">
                              Keep local copies of images you want to preserve long-term.
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              Check your storage analytics regularly to avoid surprises.
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                {profile?.subscription_plan === 'free' && (
                  <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-yellow-900">Free Plan Limitations</h3>
                        <p className="text-yellow-800 mt-1">
                          Your images are automatically deleted after 48 hours on the free plan. 
                          Upgrade to keep your images permanently and get more storage space.
                        </p>
                        <Link href="/pricing">
