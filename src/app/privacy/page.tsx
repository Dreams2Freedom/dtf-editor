  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="prose prose-gray max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 py-12">
        ...
        <h2>Introduction</h2>
        <p>
          DTF Editor (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to protecting
          your privacy. This Privacy Policy explains how we collect,
          use, disclose, and safeguard your information when you use our
          AI-powered image processing service for Direct to Film (DTF)
          printing.
        </p>
        <p>
        ...
        <p>
          Your images are stored securely in our cloud storage system
          and are only accessible to you. We retain processed images
          for 30 days to allow you to re-download them, after which
        ...
        <p>
          Each of these services has their own privacy policy and data
          handling practices. We only share the minimum necessary
          information required to provide the requested service.
        </p>
        ...
        <p>
          ...
          from the laws of your country. We ensure appropriate
        ...
        <p>
          ...
          this page and updating the &ldquo;Last updated&rdquo; date. For
          significant changes, we will provide additional notice via
