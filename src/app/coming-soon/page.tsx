      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12">
            The ultimate AI-powered platform for creating professional DTF transfers. 
            Transform your designs with one-click background removal, AI upscaling, and instant vectorization.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Instant Vectorization</h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="mt-12 text-center text-gray-600 text-sm">
            ...
            <div className="mt-4 space-x-6">
              ...
              <a href="mailto:support@dtfeditor.com" className="hover:text-gray-900 transition-colors">Contact</a>
            </div>
          </div>
        </div>
      </div>
