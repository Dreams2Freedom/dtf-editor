...
<section className={styles.hero}>
  ...
  <a className={`${styles.hero__cta} ${styles['hero__cta--primary']}`}>
    Get started
  </a>
</section>;
```
...
/* Hero.module.css */
.hero {
  @apply relative grid place-items-center gap-6 px-4 py-20 text-center;
}
.hero__title {
  @apply text-3xl font-bold text-gray-900;
}
.hero__cta {
  @apply inline-flex h-12 items-center rounded-lg px-6 transition-colors;
}
.hero__cta--primary {
